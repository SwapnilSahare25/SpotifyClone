...
class LoginViewController: UIViewController {
  ...
  private func setupMainView(){
    ...
    let signInBtn = UIFactory.makeButton(title: "Sign In",titleColor: PrimaryTextColor,font: UIFont(name: fontNameBold, size: SubTitleFontsize) ?? .boldSystemFont(ofSize: 12),backgroundColor: BtnBGColor,cornerRadius: 25*DeviceMultiplier)
  ...
  @objc func btnClicked(_ sender: UIButton){
    UserAuthenticationService.shared.login(from: self)
  }
