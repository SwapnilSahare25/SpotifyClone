...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func goToMainApp() {
    ...
    let tabs = [
      ...
      TabItem(viewController: homeVc, title: "Home", selectedImageName: "homeSelected", unSelectedImageName: "homeUnselected"),
      TabItem(viewController: searchVc, title: "Search", selectedImageName: "searchSelected", unSelectedImageName: "searchUnselected"),
      TabItem(viewController: libraryVc, title: "Library", selectedImageName: "librarySelected", unSelectedImageName: "libraryUnselected")
    ]
    ...
    window.rootViewController = tabManager
    window.makeKeyAndVisible()
